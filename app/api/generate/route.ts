...
.pg-body{padding:8px 16px 6px;display:flex;flex-direction:column;gap:0;flex:1;}
...
.sec-title{font-family:var(--display);font-size:14px;font-weight:700;color:var(--dark);line-height:1.25;letter-spacing:-0.3px;margin-bottom:2px;}
.sec-rule{width:28px;height:2px;background:var(--rose);margin-bottom:8px;flex-shrink:0;}
.card-callout{display:flex;gap:10px;background:var(--rose-faint);border:1px solid var(--rose-lt);border-radius:5px;padding:10px 12px;margin:7px 0;flex-shrink:0;}
...
.cc-body h4{font-family:var(--serif);font-size:10.5px;font-weight:600;color:var(--rose);margin-bottom:5px;}
.cc-body p{font-family:var(--sans);font-size:10px;color:var(--mid);line-height:1.75;word-break:keep-all;}
.cc-tagline{display:block;margin-top:5px;font-family:var(--serif);font-size:9px;font-style:italic;color:var(--rose-mid);}
.multi-cards{display:flex;gap:8px;margin:7px 0;flex-shrink:0;}
.mini-card{display:flex;flex-direction:column;align-items:center;gap:4px;flex:1;}
.mini-card img{width:38px;border-radius:3px;box-shadow:2px 4px 10px rgba(80,20,20,0.2);display:block;}
...
.sub-h{font-family:var(--serif);font-size:11px;font-weight:600;color:var(--rose);margin:9px 0 5px;line-height:1.4;}
.body-p{font-family:var(--sans);font-size:10.5px;color:var(--dark);line-height:1.8;letter-spacing:0.05px;margin-bottom:6px;word-break:keep-all;}
.cmp-row{display:flex;gap:7px;margin:6px 0;flex-shrink:0;}
.bad-box{border-left:3px solid var(--rose-mid);background:#FDF4F6;border-radius:0 4px 4px 0;padding:8px 11px;flex:1;}
.good-box{border-left:3px solid var(--gold);background:var(--gold-lt);border-radius:0 4px 4px 0;padding:8px 11px;flex:1;}
.box-title{font-family:var(--serif);font-size:10.5px;font-weight:600;margin-bottom:5px;}
...
.bad-box li,.good-box li{font-family:var(--sans);font-size:10px;color:var(--mid);padding-left:11px;position:relative;line-height:1.65;word-break:keep-all;}
...
.data-table th{background:var(--rose-pale);color:var(--rose);font-family:var(--serif);font-weight:600;padding:5px 8px;border:1px solid var(--rose-lt);text-align:center;font-size:9.5px;}
.data-table td{font-family:var(--sans);font-size:9.5px;color:var(--dark);padding:5px 8px;border:1px solid var(--divider);line-height:1.55;word-break:keep-all;vertical-align:top;}
.data-table tr:nth-child(even) td{background:var(--cream-mid);}
.quote-box{background:var(--rose);border-radius:5px;padding:9px 13px;margin:7px 0;flex-shrink:0;text-align:center;}
.quote-box p{font-family:var(--display);font-size:10.5px;font-style:italic;color:#fff;line-height:1.65;}
.tip-box{background:var(--gold-lt);border:1px solid #D0B080;border-radius:4px;padding:8px 12px;margin:7px 0;flex-shrink:0;}
...
.tip-box p{font-family:var(--sans);font-size:10px;color:#5C3A10;line-height:1.7;word-break:keep-all;}
...
.div-rule{height:0.5px;background:var(--divider);margin:7px 0 5px;flex-shrink:0;}
.summary-list{list-style:none;display:flex;flex-direction:column;gap:9px;margin:10px 0;}
.summary-list li{font-family:var(--sans);font-size:10.5px;color:var(--dark);padding-left:18px;position:relative;line-height:1.7;word-break:keep-all;}
...

{
  ...
  "badExamples": ["잘못된 해석 원칙 예시1.","잘못된 해석 원칙 예시2.","잘못된 해석 원칙 예시3.","잘못된 해석 원칙 예시4."],
  "goodExamples": ["올바른 해석 원칙 예시1.","올바른 해석 원칙 예시2.","올바른 해석 원칙 예시3.","올바른 해석 원칙 예시4."],
  ...
  "cases": [
    ...
    {"question": "실제 배열 예시 질문 3 (카드 3장 이상 포함).", "answer": "위치/조합 원칙을 적용한 해석. 반드시 마침표로 끝낼 것."}
  ],
  "quiz": {
...

{
  ...
  "badExamples": ["이 상황에서 잘못 해석하는 예시1.","잘못된 해석 예시2.","잘못된 해석 예시3.","잘못된 해석 예시4."],
...
{"title":"${section.title}","cardFile":"${section.card}","cardName":"${section.cardName}","cardDesc":"한 문장. 마침표로 끝낼 것.","cardTagline":"한 줄.","subheadings":[{"title":"🔮 소제목1","body":"한 문장."},{"title":"💡 소제목2","body":"한 문장."},{"title":"💬 소제목3","body":"한 문장."}],"extraCards":[${section.extraCards.map(c=>`{"file":"${c.file}","name":"${c.name}","interp":"한 줄."}`).join(",")}],"badExamples":["예시1.","예시2.","예시3.","예시4."],"goodExamples":["예시1.","예시2.","예시3.","예시4."],"tableHeaders":["상황","정방향","역방향"],"tableRows":[{"col1":"상황1","col2":"정방향1","col3":"역방향1"},{"col1":"상황2","col2":"정방향2","col3":"역방향2"},{"col1":"상황3","col2":"정방향3","col3":"역방향3"},{"col1":"상황4","col2":"정방향4","col3":"역방향4"},{"col1":"상황5","col2":"정방향5","col3":"역방향5"}],"quote":"한 문장.","tip":"한 문장.","cases":[{"question":"질문1.","answer":"답변1."},{"question":"질문2.","answer":"답변2."},{"question":"질문3.","answer":"답변3."}],"quiz":{"question":"🎯 퀴즈: 카드 3장 배열 제시.","hint":"힌트 한 줄.","answer":"해설 한 문장."},"summary":["요약1.","요약2.","요약3.","요약4."]}`;
}
