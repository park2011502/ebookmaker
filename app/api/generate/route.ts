...

{
  ...
  "cases": [
    {"question": "이 연애 상황(${section.title}) 실제 상담 질문 1. 반드시 연애·관계·감정에 관한 질문으로만 작성할 것.", "answer": "4~5문장. 카드 3가지 이상 옵션을 포함한 풍부한 답변. 반드시 마침표로 끝낼 것."},
    {"question": "이 연애 상황(${section.title}) 실제 상담 질문 2. 반드시 연애·관계·감정에 관한 질문으로만 작성할 것.", "answer": "4~5문장. 카드 3가지 이상 옵션을 포함한 풍부한 답변. 반드시 마침표로 끝낼 것."},
    {"question": "이 연애 상황(${section.title}) 실제 상담 질문 3. 반드시 연애·관계·감정에 관한 질문으로만 작성할 것.", "answer": "4~5문장. 카드 3가지 이상 옵션을 포함한 풍부한 답변. 반드시 마침표로 끝낼 것."}
  ],
  "quiz": {
...
{"title":"${section.title}","cardFile":"${section.card}","cardName":"${section.cardName}","cardDesc":"5~6문장. 이 카드의 연애 핵심 의미. 정방향과 역방향, 실제 연애 상황 예시 포함. 반드시 존댓말로, 마침표로 끝낼 것.","cardTagline":"이 카드의 연애 핵심 메시지 한 줄.","subheadings":[{"title":"🔮 소제목1","body":"5~6문장. 이 섹션 주제 관련 핵심 연애 내용을 구체적으로. 실제 예시 포함. 반드시 존댓말로, 마침표로 끝낼 것."},{"title":"💡 소제목2","body":"5~6문장. 실전 연애 적용법을 구체적으로. 어떤 상황에서 어떻게 활용하는지. 반드시 존댓말로, 마침표로 끝낼 것."},{"title":"💬 소제목3","body":"5~6문장. 실제 연애 예시와 함께 설명. 독자가 바로 공감할 수 있게. 반드시 존댓말로, 마침표로 끝낼 것."}],"extraCards":[${section.extraCards.map(c=>`{"file":"${c.file}","name":"${c.name}","interp":"연애 리딩에서 한 줄 의미. 존댓말로."}`).join(",")}],"badExamples":["잘못된 연애 해석 예시1.","잘못된 연애 해석 예시2.","잘못된 연애 해석 예시3.","잘못된 연애 해석 예시4."],"goodExamples":["올바른 연애 해석 예시1.","올바른 연애 해석 예시2.","올바른 연애 해석 예시3.","올바른 연애 해석 예시4."],"tableHeaders":["연애 상황","정방향","역방향"],"tableRows":[{"col1":"상황1","col2":"정방향 연애 의미1","col3":"역방향 연애 의미1"},{"col1":"상황2","col2":"정방향 연애 의미2","col3":"역방향 연애 의미2"},{"col1":"상황3","col2":"정방향 연애 의미3","col3":"역방향 연애 의미3"},{"col1":"상황4","col2":"정방향 연애 의미4","col3":"역방향 연애 의미4"},{"col1":"상황5","col2":"정방향 연애 의미5","col3":"역방향 연애 의미5"}],"quote":"연애 리딩 핵심 명언 한 문장. 존댓말로.","tip":"실전 연애 리딩 팁 2문장. 존댓말로.","cases":[{"question":"실제 연애 상담 질문1.","answer":"3~4문장. 풍부한 연애 해석. 존댓말로."},{"question":"실제 연애 상담 질문2.","answer":"3~4문장. 풍부한 연애 해석. 존댓말로."},{"question":"실제 연애 상담 질문3.","answer":"3~4문장. 풍부한 연애 해석. 존댓말로."}],"quiz":{"question":"🎯 연애 퀴즈: 카드 3장 연애 배열 제시. 반드시 연애 상황으로.","hint":"힌트 한 줄. 존댓말로.","answer":"해설 2문장. 존댓말로."},"summary":["핵심 요약1. 존댓말로.","핵심 요약2. 존댓말로.","핵심 요약3. 존댓말로.","핵심 요약4. 존댓말로."]}`;
}
