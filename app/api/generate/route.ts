...
function buildSectionPrompt(chapterNum: number, chapterTitle: string, section: { title: string; card: string; cardName: string; extraCards: { file: string; name: string }[] }, si: number): string {
  ...
  if (chapterNum === 3) {
    ...
    {"question": "${section.title} 관련 실제 연애 상담 질문 2. 앞의 질문과 다른 연애 고민 상황", "answer": "2문장. 카드를 하나씩 나열하지 말고 전체 배열을 하나의 흐름으로 통합 해석. 모든 카드와 결론까지 반드시 포함. 내용이 풍부하고 빠지는 카드 없이. 반드시 존댓말로, 마침표로 끝낼 것."}`
      : `{"question": "구체적인 연애 고민 + 이때 [카드명1], [카드명2], [카드명3]이 나왔어요 형식으로. 1~2줄 이내. 정방향/역방향 포함. 다른 케이스와 완전히 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."},
    {"question": "앞과 다른 연애 고민 + 이때 [카드명1], [카드명2], [카드명3]이 나왔어요 형식으로. 1~2줄 이내. 정방향/역방향 포함. 완전히 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."},
    {"question": "앞 둘과 다른 연애 고민 + 이때 [카드명1], [카드명2], [카드명3]이 나왔어요 형식으로. 1~2줄 이내. 정방향/역방향 포함. 완전히 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."}`;
