...
// ── 챕터 구성 (연애/금전/직업 각 100개) ─────────────────
const CHAPTERS = [
  {
    number: 1, title: "연애 질문 리스트 100",
    icon: "💕", color: "rose",
    sections: [
      { title: "썸·설렘 단계", icon: "🌸", cardFile: "Cups02.jpg", cardName: "컵 2", count: 10,
        desc: "좋아하는 마음이 생겼을 때, 상대의 마음을 확인하고 싶을 때 사용하는 질문들" },
      { title: "고백·타이밍", icon: "💌", cardFile: "RWS_Tarot_00_Fool.jpg", cardName: "바보", count: 10,
        desc: "고백 타이밍과 상대의 반응을 미리 알고 싶을 때 사용하는 질문들" },
      { title: "연애 중·감정 확인", icon: "💑", cardFile: "TheLovers.jpg", cardName: "연인", count: 10,
        desc: "사귀는 중 서로의 감정과 관계 온도를 확인하고 싶을 때 사용하는 질문들" },
      { title: "권태기·신뢰 문제", icon: "🌧️", cardFile: "Cups04.jpg", cardName: "컵 4", count: 10,
        desc: "권태기가 왔거나 신뢰 문제가 생겼을 때 사용하는 질문들" },
      { title: "미래·결혼 전망", icon: "💍", cardFile: "RWS_Tarot_21_World.jpg", cardName: "세계", count: 10,
        desc: "이 관계의 미래와 결혼 가능성을 알고 싶을 때 사용하는 질문들" },
      { title: "이별·감정 정리", icon: "💔", cardFile: "Cups08.jpg", cardName: "컵 8", count: 10,
        desc: "이별 후 감정을 정리하고 다음 단계를 알고 싶을 때 사용하는 질문들" },
      { title: "재회·연락 가능성", icon: "🔄", cardFile: "RWS_Tarot_20_Judgement.jpg", cardName: "심판", count: 10,
        desc: "헤어진 상대와 재회 가능성을 알고 싶을 때 사용하는 질문들" },
      { title: "상대 마음 읽기", icon: "🔮", cardFile: "RWS_Tarot_18_Moon.jpg", cardName: "달", count: 10,
        desc: "상대방이 숨기는 감정과 속마음을 파악하고 싶을 때 사용하는 질문들" },
      { title: "삼각관계·복잡한 상황", icon: "⚡", cardFile: "Swords03.jpg", cardName: "검 3", count: 10,
        desc: "삼각관계나 복잡한 연애 상황에서 방향을 찾고 싶을 때 사용하는 질문들" },
      { title: "나를 위한 연애 리딩", icon: "🌟", cardFile: "RWS_Tarot_19_Sun.jpg", cardName: "태양", count: 10,
        desc: "자존감 회복과 다음 인연 준비를 위해 사용하는 질문들" },
    ],
  },
  {
    number: 2, title: "금전 질문 리스트 100",
    icon: "💰", color: "gold",
    sections: [
      { title: "수입 흐름·돈이 들어올까", icon: "💵", cardFile: "Pents06.jpg", cardName: "펜타클 6", count: 10,
        desc: "수입이 언제, 얼마나 들어올지 알고 싶을 때 사용하는 질문들" },
      { title: "투자·재테크 타이밍", icon: "📈", cardFile: "RWS_Tarot_10_Wheel_of_Fortune.jpg", cardName: "운명의 수레바퀴", count: 10,
        desc: "투자 타이밍과 재테크 방향을 결정할 때 사용하는 질문들" },
      { title: "지출·손재수 파악", icon: "💸", cardFile: "Pents05.jpg", cardName: "펜타클 5", count: 10,
        desc: "돈이 새는 이유와 손재수를 파악하고 싶을 때 사용하는 질문들" },
      { title: "부채·빚 해결", icon: "⚖️", cardFile: "RWS_Tarot_15_Devil.jpg", cardName: "악마", count: 10,
        desc: "부채나 빚 문제의 해결 시기를 알고 싶을 때 사용하는 질문들" },
      { title: "사업·창업 가능성", icon: "🏢", cardFile: "Wands03.jpg", cardName: "완드 3", count: 10,
        desc: "사업 가능성과 창업 타이밍을 확인하고 싶을 때 사용하는 질문들" },
      { title: "동업·계약·파트너십", icon: "🤝", cardFile: "RWS_Tarot_11_Justice.jpg", cardName: "정의", count: 10,
        desc: "동업이나 계약 상황에서 신중한 판단을 하고 싶을 때 사용하는 질문들" },
      { title: "직장 연봉·성과급", icon: "💼", cardFile: "Pents08.jpg", cardName: "펜타클 8", count: 10,
        desc: "연봉 협상과 성과급 가능성을 알고 싶을 때 사용하는 질문들" },
      { title: "부동산·큰 자산", icon: "🏠", cardFile: "Pents10.jpg", cardName: "펜타클 10", count: 10,
        desc: "부동산 매매나 큰 자산 결정을 할 때 사용하는 질문들" },
      { title: "금전 운·전반적 흐름", icon: "✨", cardFile: "RWS_Tarot_17_Star.jpg", cardName: "별", count: 10,
        desc: "현재 전반적인 금전 운과 흐름을 파악하고 싶을 때 사용하는 질문들" },
      { title: "풍요 마인드·금전 에너지", icon: "🌟", cardFile: "RWS_Tarot_19_Sun.jpg", cardName: "태양", count: 10,
        desc: "금전 마인드를 높이고 풍요를 끌어당기기 위한 질문들" },
    ],
  },
  {
    number: 3, title: "직업 질문 리스트 100",
    icon: "💼", color: "navy",
    sections: [
      { title: "취업·합격 가능성", icon: "🎯", cardFile: "RWS_Tarot_07_Chariot.jpg", cardName: "전차", count: 10,
        desc: "취업 합격 가능성과 면접 결과를 알고 싶을 때 사용하는 질문들" },
      { title: "이직·직장 변화", icon: "🔄", cardFile: "RWS_Tarot_00_Fool.jpg", cardName: "바보", count: 10,
        desc: "이직 타이밍과 새로운 직장으로의 변화를 결정할 때 사용하는 질문들" },
      { title: "승진·인사 평가", icon: "⭐", cardFile: "Pents08.jpg", cardName: "펜타클 8", count: 10,
        desc: "승진 가능성과 인사 평가 결과를 알고 싶을 때 사용하는 질문들" },
      { title: "직장 내 관계·갈등", icon: "🤝", cardFile: "Swords02.jpg", cardName: "검 2", count: 10,
        desc: "직장 내 인간관계와 갈등 상황을 파악하고 싶을 때 사용하는 질문들" },
      { title: "연봉 협상·처우", icon: "💰", cardFile: "Pents06.jpg", cardName: "펜타클 6", count: 10,
        desc: "연봉 협상과 처우 개선 가능성을 알고 싶을 때 사용하는 질문들" },
      { title: "창업·독립 가능성", icon: "🌱", cardFile: "Wands01.jpg", cardName: "완드 에이스", count: 10,
        desc: "창업이나 프리랜서 독립 가능성을 탐색하고 싶을 때 사용하는 질문들" },
      { title: "사업 운영·파트너십", icon: "🏢", cardFile: "RWS_Tarot_04_Emperor.jpg", cardName: "황제", count: 10,
        desc: "사업 운영 방향과 비즈니스 파트너십을 결정할 때 사용하는 질문들" },
      { title: "적성·나에게 맞는 일", icon: "🌈", cardFile: "RWS_Tarot_17_Star.jpg", cardName: "별", count: 10,
        desc: "나에게 맞는 직업과 적성을 탐색하고 싶을 때 사용하는 질문들" },
      { title: "직업 전환·새로운 분야", icon: "🚀", cardFile: "RWS_Tarot_20_Judgement.jpg", cardName: "심판", count: 10,
        desc: "새로운 분야로의 전환 가능성을 알고 싶을 때 사용하는 질문들" },
      { title: "커리어 성장·미래 전망", icon: "🌟", cardFile: "RWS_Tarot_21_World.jpg", cardName: "세계", count: 10,
        desc: "장기적인 커리어 성장과 미래 전망을 확인하고 싶을 때 사용하는 질문들" },
    ],
  },
];
...
.cover-toc{margin:11px 26px 0;display:grid;grid-template-columns:repeat(3,1fr);gap:6px;}
...
function buildCoverHtml(): string {
  const cards = [
    { file: "Cups02.jpg", label: "Cups II", w: 52, mb: 10, op: 0.85 },
    { file: "Pents01.jpg", label: "Pentacles I", w: 66, mb: 4, op: 1 },
    { file: "RWS_Tarot_21_World.jpg", label: "The World", w: 82, mb: 0, op: 1 },
    { file: "RWS_Tarot_07_Chariot.jpg", label: "The Chariot", w: 66, mb: 4, op: 1 },
    { file: "RWS_Tarot_17_Star.jpg", label: "The Star", w: 52, mb: 10, op: 0.85 },
  ];
  return `<div class="pg"><div class="cover-top"><div class="cover-vol-en">Special Edition · Tarot Question List 300</div><div class="cover-vol-kr">부 록 2</div></div><div class="cover-cards-row">${cards.map(c=>`<div class="c-card"><img src="${BASE_URL}/cards/${c.file}" style="width:${c.w}px;margin-bottom:${c.mb}px;opacity:${c.op};" alt="${c.label}"><div class="clbl">${c.label}</div></div>`).join("")}</div><div class="cover-title-block"><div class="cover-main-title">타로에게 묻는<br>질문 리스트 300</div><div class="cover-rule"></div><div class="cover-subtitle">연애·금전·직업 상황별 완벽 질문 모음</div><div class="cover-tagline">부록 2 · 주제별 100개씩 총 300개 수록</div></div><div class="cover-dots"><span></span><span class="on"></span><span></span></div><div class="cover-learn"><h4>이 책에서 배울 것들</h4><ul><li>좋은 타로 질문이 리딩 퀄리티를 결정한다</li><li>연애 100개 — 썸부터 재회까지 모든 상황</li><li>금전 100개 — 수입·투자·사업·부동산 전 분야</li><li>직업 100개 — 취업·이직·승진·창업·적성 완전 정복</li></ul></div><div class="cover-toc">${["연애 100","금전 100","직업 100"].map((t,i)=>`<div class="toc-cell"><div class="tn">0${i+1}</div><div class="tl">${t}</div></div>`).join("")}</div><div class="cover-bottom"><div class="cover-bottom-l">Tarot Question List 300</div><div class="cover-bottom-r">부록 2 · 주제별 100개씩 총 300개</div></div></div>`;
}

function buildOpenerHtml(ch: typeof CHAPTERS[0], pageNum: number): string {
  const descs: Record<number, string> = {
    1: "타로 리딩의 퀄리티는 질문에서 결정됩니다. 연애에서 좋은 질문은 막연한 궁금증을 구체적인 답으로 바꿔줘요. 썸부터 재회까지 모든 연애 상황에 바로 쓸 수 있는 100개 질문을 모았습니다.",
    2: "돈에 관한 질문은 구체적일수록 정확한 답이 나옵니다. 수입·지출·투자·사업·부동산까지 금전의 모든 흐름을 타로로 읽을 수 있는 현장 검증 질문 100개를 담았습니다.",
    3: "커리어 리딩에서 질문의 방향이 곧 답의 방향입니다. 취업·이직·승진·창업·적성까지 직업의 모든 고민을 타로에게 제대로 물어볼 수 있는 100개 질문을 모았습니다.",
  };
  return `<div class="pg"><div class="pg-hd"><span>타로에게 묻는 질문 리스트 300 | 주제별 100개</span><span>CHAPTER 0${ch.number}</span></div><div class="opener-body"><div class="op-label">CHAPTER</div><div class="op-num">0${ch.number}</div><div class="op-title">${ch.icon} ${ch.title}</div><div class="op-rule"></div><div class="op-desc">${descs[ch.number]}</div><div class="op-sections"><h4>이번 챕터 구성 (총 100개)</h4><ul>${ch.sections.map(s=>`<li>${s.icon} ${s.title} — ${s.count}개</li>`).join("")}</ul></div></div><div class="pg-ft"><div class="pn">${pageNum}</div><div class="pt">Tarot Question List</div></div></div>`;
}
...
function buildQuestionPageHtml(
  ...
  return `<div class="pg"><div class="pg-hd"><span>타로에게 묻는 질문 리스트 300 | 주제별 100개</span><span>CH 0${ch.number} · ${ch.title}</span></div><div class="pg-body"><div class="q-section-header"><div class="q-card-img"><img src="${BASE_URL}/cards/${sec.cardFile}" alt="${sec.cardName}"></div><div class="q-header-text"><div class="q-badge">Question List · ${ch.icon} ${ch.title}</div><div class="q-section-title">${sec.icon} ${sec.title}</div><div class="q-section-desc">${sec.desc}</div></div></div><div class="q-rule"></div><div class="q-tip"><div class="q-tip-text">💡 ${trimSentences(data.tip, 1)}</div></div><ul class="q-list">${qItems}</ul></div><div class="pg-ft"><div class="pn">${pageNum}</div><div class="pt">Tarot Question List</div></div></div>`;
}
...
- 반드시 존댓말(~해요, ~입니다, ~이에요)로만 작성할 것.
{
  "tip": "이 상황에서 타로 질문을 잘 만드는 핵심 비결 1문장. 반드시 마침표로 끝낼 것.",
  "questions": [
    ${Array.from({length:10},(_,i)=>`{"num":${startNum+i},"text":"구체적인 타로 질문. ~할까요?/~일까요? 형태로 끝낼 것.","point":"이 질문을 사용하면 좋은 상황 한 문장. 반드시 마침표로 끝낼 것."}`).join(",\n    ")}
  ]
}
JSON만 출력.`;
}
...
export async function POST(req: NextRequest) {
  try {
    ...
    const html = buildQuestionPageHtml(ch, sec, data, startPage);
    return NextResponse.json({ html, nextStartPage: startPage + 1 });
