...
function buildSectionPrompt(
  ...
  if (chapterNum === 3) {
    ...
    const casesPrompt = is5card
      ? `{"question": "[구체적 금전 고민] — [카드명1/카드명2/카드명3/카드명4/카드명5] 나왔을 때 어떻게 해석할까요? 반드시 질문에 카드명 포함. 다른 케이스와 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 상황/원인/장애/조언/결과 전체를 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."},
    {"question": "[앞과 다른 금전 고민] — [카드명1/카드명2/카드명3/카드명4/카드명5] 나왔을 때 어떻게 해석할까요? 반드시 질문에 카드명 포함. 완전히 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 상황/원인/장애/조언/결과 전체를 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."}`
      : `{"question": "\[구체적 금전 고민] — [카드명1/카드명2/카드명3] 나왔을 때 어떻게 해석할까요? 반드시 질문에 카드명 포함. 다른 케이스와 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."},
    {"question": "\[앞과 다른 금전 고민] — [카드명1/카드명2/카드명3] 나왔을 때 어떻게 해석할까요? 반드시 질문에 카드명 포함. 완전히 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."},
    {"question": "\[앞 둘과 다른 금전 고민] — [카드명1/카드명2/카드명3] 나왔을 때 어떻게 해석할까요? 반드시 질문에 카드명 포함. 완전히 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."}`;
...
- 케이스와 퀴즈는 반드시 금전·재테크에 관한 내용으로만 작성할 것. 연애·자아성찰 내용 절대 금지.
{
  ...
  "cases": [
    {"question": "[구체적 금전 고민] — [카드명1/카드명2/카드명3] 나왔을 때 어떻게 해석할까요? 반드시 질문에 카드명 포함. 다른 케이스와 완전히 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."},
    {"question": "[앞과 다른 금전 고민] — [카드명1/카드명2/카드명3] 나왔을 때 어떻게 해석할까요? 반드시 질문에 카드명 포함. 완전히 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."},
    {"question": "[앞 둘과 다른 금전 고민] — [카드명1/카드명2/카드명3] 나왔을 때 어떻게 해석할까요? 반드시 질문에 카드명 포함. 완전히 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."}
  ],
  "quiz": {
