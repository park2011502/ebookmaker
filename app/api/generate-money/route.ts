...
const MINOR_PAGES = [
  ...
  { suit: "완드 (Wands) — 행동과 창업", cards: [{ file: "Wands03.jpg", name: "완드 3" }, { file: "Wands04.jpg", name: "완드 4" }, { file: "Wands05.jpg", name: "완드 5" }, { file: "Wands06.jpg", name: "완드 6" }] },
  { suit: "완드 (Wands) — 행동과 창업", cards: [{ file: "Wands07.jpg", name: "완드 7" }, { file: "Wands08.jpg", name: "완드 8" }, { file: "Tarot_Nine_of_Wands.jpg", name: "완드 9" }, { file: "Wands10.jpg", name: "완드 10" }] },
  { suit: "완드 (Wands) — 행동과 창업", cards: [{ file: "Wands11.jpg", name: "완드 페이지" }, { file: "Wands12.jpg", name: "완드 나이트" }, { file: "Wands13.jpg", name: "완드 퀸" }, { file: "Wands14.jpg", name: "완드 킹" }] },
  { suit: "검 (Swords) — 결단과 갈등", cards: [{ file: "Swords01.jpg", name: "검 에이스" }, { file: "Swords02.jpg", name: "검 2" }, { file: "Swords03.jpg", name: "검 3" }, { file: "Swords04.jpg", name: "검 4" }] },
  { suit: "검 (Swords) — 결단과 갈등", cards: [{ file: "Swords05.jpg", name: "검 5" }, { file: "Swords06.jpg", name: "검 6" }, { file: "Swords07.jpg", name: "검 7" }, { file: "Swords08.jpg", name: "검 8" }] },
  { suit: "검 (Swords) — 결단과 갈등", cards: [{ file: "Swords09.jpg", name: "검 9" }, { file: "Swords10.jpg", name: "검 10" }, { file: "Swords11.jpg", name: "검 페이지" }, { file: "Swords12.jpg", name: "검 나이트" }] },
  { suit: "검 (Swords) — 결단과 갈등", cards: [{ file: "Swords13.jpg", name: "검 퀸" }, { file: "Swords14.jpg", name: "검 킹" }, { file: "Pents01.jpg", name: "펜타클 에이스" }, { file: "Pents02.jpg", name: "펜타클 2" }] },
  { suit: "펜타클 (Pentacles) — 돈과 물질", cards: [{ file: "Pents03.jpg", name: "펜타클 3" }, { file: "Pents04.jpg", name: "펜타클 4" }, { file: "Pents05.jpg", name: "펜타클 5" }, { file: "Pents06.jpg", name: "펜타클 6" }] },
...
const CHAPTERS = [
  {
    number: 2, title: "금전 타로의 시작 — 질문법과 리딩 준비",
    sections: [
      { title: "돈 관련 질문을 제대로 만드는 법", card: "Pents01.jpg", cardName: "펜타클 에이스", extraCards: [{ file: "RWS_Tarot_10_Wheel_of_Fortune.jpg", name: "운명의 수레바퀴" }] },
      { title: "리딩 전 마음 세팅과 금전 에너지 다루기", card: "RWS_Tarot_08_Strength.jpg", cardName: "힘 (Strength)", extraCards: [{ file: "RWS_Tarot_09_Hermit.jpg", name: "은둔자" }] },
      { title: "정방향과 역방향, 금전 해석이 달라지는 원리", card: "RWS_Tarot_11_Justice.jpg", cardName: "정의 (Justice)", extraCards: [{ file: "RWS_Tarot_12_Hanged_Man.jpg", name: "매달린 사람" }] },
      { title: "카드가 전하는 금전 메시지를 읽는 5가지 원칙", card: "Pents10.jpg", cardName: "펜타클 10", extraCards: [{ file: "RWS_Tarot_21_World.jpg", name: "세계" }] },
    ],
  },
  {
    number: 3, title: "카드 위치와 조합 해석 — 금전 리딩의 핵심",
    sections: [
      { title: "3카드 스프레드 — 과거/현재/미래 금전 흐름", card: "Pents07.jpg", cardName: "펜타클 7", extraCards: [{ file: "RWS_Tarot_10_Wheel_of_Fortune.jpg", name: "운명의 수레바퀴" }, { file: "RWS_Tarot_19_Sun.jpg", name: "태양" }] },
      { title: "5카드 스프레드 — 상황/원인/장애/조언/결과", card: "Pents08.jpg", cardName: "펜타클 8", extraCards: [{ file: "Pents05.jpg", name: "펜타클 5" }, { file: "RWS_Tarot_17_Star.jpg", name: "별" }] },
      { title: "카드 조합 해석 — 함께 나오면 달라지는 금전 의미", card: "Pents09.jpg", cardName: "펜타클 9", extraCards: [{ file: "RWS_Tarot_16_Tower.jpg", name: "탑" }, { file: "RWS_Tarot_15_Devil.jpg", name: "악마" }] },
  ...
  {
    number: 4, title: "금전 상담 실전 완전 정복 I — 수입·지출·투자",
    sections: [
      { title: "수입 운 — 언제 돈이 들어올까", card: "Pents06.jpg", cardName: "펜타클 6", extraCards: [{ file: "RWS_Tarot_19_Sun.jpg", name: "태양" }, { file: "Wands08.jpg", name: "완드 8" }] },
      { title: "지출 및 손재수 — 돈이 새는 이유", card: "Pents05.jpg", cardName: "펜타클 5", extraCards: [{ file: "RWS_Tarot_16_Tower.jpg", name: "탑" }, { file: "RWS_Tarot_15_Devil.jpg", name: "악마" }] },
      { title: "투자 및 재테크 — 지금 투자해도 될까", card: "RWS_Tarot_10_Wheel_of_Fortune.jpg", cardName: "운명의 수레바퀴", extraCards: [{ file: "Pents07.jpg", name: "펜타클 7" }, { file: "RWS_Tarot_19_Sun.jpg", name: "태양" }] },
      { title: "부채 및 빚 — 언제 해결될까", card: "RWS_Tarot_15_Devil.jpg", cardName: "악마 (The Devil)", extraCards: [{ file: "Swords08.jpg", name: "검 8" }, { file: "RWS_Tarot_20_Judgement.jpg", name: "심판" }] },
    ],
  },
  {
    number: 5, title: "금전 상담 실전 완전 정복 II — 직장·사업·부동산",
    sections: [
      { title: "직장 운 — 이직, 승진, 연봉 협상", card: "Pents03.jpg", cardName: "펜타클 3", extraCards: [{ file: "RWS_Tarot_07_Chariot.jpg", name: "전차" }, { file: "RWS_Tarot_11_Justice.jpg", name: "정의" }] },
      { title: "사업 운 — 창업, 동업, 계약", card: "Wands03.jpg", cardName: "완드 3", extraCards: [{ file: "RWS_Tarot_04_Emperor.jpg", name: "황제" }, { file: "RWS_Tarot_11_Justice.jpg", name: "정의" }] },
      { title: "부동산 및 큰 자산 — 매매, 임대, 타이밍", card: "Pents10.jpg", cardName: "펜타클 10", extraCards: [{ file: "RWS_Tarot_04_Emperor.jpg", name: "황제" }, { file: "RWS_Tarot_18_Moon.jpg", name: "달" }] },
      { title: "금전 고민별 추천 스프레드 완전 가이드", card: "RWS_Tarot_03_Empress.jpg", cardName: "여황제 (The Empress)", extraCards: [{ file: "Pents09.jpg", name: "펜타클 9" }, { file: "RWS_Tarot_17_Star.jpg", name: "별" }] },
      { title: "나를 위한 리딩 — 금전 마인드와 풍요 준비", card: "RWS_Tarot_19_Sun.jpg", cardName: "태양 (The Sun)", extraCards: [{ file: "Pents09.jpg", name: "펜타클 9" }, { file: "RWS_Tarot_21_World.jpg", name: "세계" }] },
    ],
  },
];
// ── CSS (골드/노란 톤) ──────────────────────────────────
...
:root{
  --cream:#FDFBF3;--cream-mid:#F5F0DC;
  --gold:#8B6914;--gold-mid:#B8920A;--gold-lt:#E8D48A;--gold-pale:#FDF8E1;--gold-faint:#FEFDF0;
  --amber:#C4920A;--amber-lt:#F0D060;
  --dark:#1A1208;--mid:#4A3510;--light:#8A6820;--divider:#DDD0A0;
  --serif:'Noto Serif KR',Georgia,serif;--sans:'Noto Sans KR',sans-serif;--display:'Playfair Display','Noto Serif KR',serif;
}
html,body{background:#B8A870;-webkit-print-color-adjust:exact;print-color-adjust:exact;}
...
.card-ref-img img{width:52px;border-radius:3px;box-shadow:2px 4px 12px rgba(80,50,0,0.22);display:block;}
...
.card-ref-num{font-family:var(--display);font-size:8px;color:var(--gold-lt);margin-bottom:5px;letter-spacing:1px;}
.card-ref-kw{font-family:var(--sans);font-size:8.5px;color:var(--amber);font-weight:600;margin-bottom:5px;letter-spacing:0.3px;}
.card-ref-up{margin-bottom:4px;}
.card-ref-down{margin-bottom:4px;}
.card-ref-label{font-family:var(--serif);font-size:8.5px;font-weight:600;color:var(--gold);margin-bottom:2px;}
...
.minor-card-top img{width:36px;border-radius:2px;box-shadow:1px 2px 6px rgba(80,50,0,0.18);flex-shrink:0;}
.minor-card-name{font-family:var(--display);font-size:9.5px;font-weight:700;color:var(--dark);line-height:1.3;margin-bottom:2px;}
.minor-card-kw{font-family:var(--sans);font-size:7.5px;color:var(--amber);font-weight:600;}
.minor-card-body{}
...
.op-rule{width:44px;height:1.5px;background:var(--gold);margin:0 auto 14px;}
...
.op-sections{width:100%;background:var(--gold-faint);border:1px solid var(--gold-lt);border-radius:5px;padding:13px 18px;text-align:left;}
.op-sections h4{font-family:var(--sans);font-size:8px;font-weight:600;color:var(--gold);letter-spacing:2px;text-transform:uppercase;margin-bottom:9px;}
...
.sec-rule{width:28px;height:2px;background:var(--gold);margin-bottom:10px;flex-shrink:0;}
.card-callout{display:flex;gap:12px;background:var(--gold-faint);border:1px solid var(--gold-lt);border-radius:5px;padding:12px 13px;margin:9px 0;flex-shrink:0;}
.cc-img{flex-shrink:0;text-align:center;}
.cc-img img{width:56px;border-radius:3px;box-shadow:2px 4px 12px rgba(80,50,0,0.22);display:block;}
...
.cc-body h4{font-family:var(--serif);font-size:12.5px;font-weight:600;color:var(--gold);margin-bottom:6px;}
.cc-body p{font-family:var(--sans);font-size:12px;color:var(--mid);line-height:1.9;word-break:keep-all;}
.cc-tagline{display:block;margin-top:5px;font-family:var(--serif);font-size:9px;font-style:italic;color:var(--gold-mid);}
...
.mini-card img{width:44px;border-radius:3px;box-shadow:2px 4px 10px rgba(80,50,0,0.2);display:block;}
...
.sub-h{font-family:var(--serif);font-size:13px;font-weight:600;color:var(--gold);margin:11px 0 6px;line-height:1.4;}
...
.bad-box{border-left:3px solid var(--amber);background:#FDF8E8;border-radius:0 4px 4px 0;padding:9px 12px;flex:1;}
.good-box{border-left:3px solid var(--gold);background:var(--gold-pale);border-radius:0 4px 4px 0;padding:9px 12px;flex:1;}
...
.bad-box li::before{content:'·';position:absolute;left:1px;color:var(--amber);font-size:14px;line-height:1.25;}
...
.data-table th{background:var(--gold-pale);color:var(--gold);font-family:var(--serif);font-weight:600;padding:6px 9px;border:1px solid var(--gold-lt);text-align:center;font-size:10.5px;}
...
.quote-box{background:var(--gold);border-radius:5px;padding:10px 14px;margin:8px 0;flex-shrink:0;text-align:center;}
.quote-box p{font-family:var(--display);font-size:11.5px;font-style:italic;color:#fff;line-height:1.7;}
.tip-box{background:var(--gold-pale);border:1px solid var(--gold-lt);border-radius:4px;padding:10px 13px;margin:8px 0;flex-shrink:0;}
...
.tip-box p{font-family:var(--sans);font-size:11.5px;color:#4A3510;line-height:1.8;word-break:keep-all;}
...
.case-title{font-family:var(--serif);font-size:11px;font-weight:600;color:var(--amber);letter-spacing:1px;margin-bottom:8px;}
.case-q{font-family:var(--sans);font-size:10px;color:var(--gold);font-style:italic;line-height:1.65;margin-bottom:5px;word-break:keep-all;}
...
.summary-list li::before{content:'✦';position:absolute;left:0;color:var(--gold);font-size:9px;line-height:1.8;}
.quiz-box{background:var(--gold-pale);border:2px solid var(--gold-lt);border-radius:6px;padding:9px 12px;margin:7px 0;flex-shrink:0;}
.quiz-title{font-family:var(--serif);font-size:10.5px;font-weight:700;color:var(--gold);margin-bottom:7px;letter-spacing:0.5px;}
...
.quiz-answer-box{background:var(--cream-mid);border-left:3px solid var(--gold);padding:8px 11px;border-radius:0 4px 4px 0;}
.quiz-answer-label{font-family:var(--sans);font-size:8px;font-weight:600;color:var(--gold);margin-bottom:4px;letter-spacing:1px;text-transform:uppercase;}
...
.cover-rule{width:44px;height:1.5px;background:var(--gold);margin:0 auto 11px;}
...
.cover-dots span{width:6px;height:6px;border-radius:50%;background:var(--gold-lt);display:inline-block;}
.cover-dots .on{background:var(--gold);}
.cover-learn{margin:0 26px;background:var(--gold-faint);border:1px solid var(--gold-lt);border-radius:5px;padding:13px 18px 12px;flex-shrink:0;}
.cover-learn h4{font-family:var(--sans);font-size:7.5px;font-weight:600;color:var(--gold);letter-spacing:2.5px;text-transform:uppercase;margin-bottom:9px;}
...
.cover-learn li::before{content:'＋';position:absolute;left:0;color:var(--gold-mid);font-size:9px;line-height:1.55;}
...
.toc-cell .tn{font-family:var(--display);font-size:13px;font-weight:700;color:var(--gold-lt);line-height:1;margin-bottom:3px;}
...
function buildCoverHtml(): string {
  const cards = [
    { file: "Pents01.jpg", label: "Pentacles I", w: 48, mb: 12, op: 0.82 },
    ...
    { file: "Pents09.jpg", label: "Pentacles IX", w: 48, mb: 12, op: 0.82 },
  ];
...
- 각 항목을 충분히 자세하게 작성하여 내용이 풍부하게 보일 것.
{
  "card1": {
    "name": "${card1.name}",
    "num": "${card1.num}",
    "keywords": "금전 핵심 키워드 3개 (예: 새로운 수입 · 투자 기회 · 사업 시작)",
    "upright": "정방향 금전 해석. 이 카드가 금전 리딩에서 정방향으로 나왔을 때 의미를 구어체로 3문장 이상 충분히 설명. 반드시 마침표로 끝낼 것.",
    "reversed": "역방향 금전 해석. 이 카드가 역방향으로 나왔을 때 의미를 구어체로 3문장 이상 충분히 설명. 반드시 마침표로 끝낼 것.",
    "consult": "금전 상담에서 이 카드가 나오면 어떤 상황을 의미하는지 구어체로 2문장. 반드시 마침표로 끝낼 것."
  },
  "card2": {
    "name": "${card2.name}",
    "num": "${card2.num}",
    "keywords": "금전 핵심 키워드 3개",
    "upright": "정방향 금전 해석 3문장 이상. 반드시 마침표로 끝낼 것.",
    "reversed": "역방향 금전 해석 3문장 이상. 반드시 마침표로 끝낼 것.",
    "consult": "금전 상담 적용 2문장. 반드시 마침표로 끝낼 것."
  }
}
JSON만 출력.`;
}
...
- 각 항목 충분히 자세하게 작성할 것.
{
  "cards": [
    ${cards.map(c=>`{
      "name": "${c.name}",
      "keywords": "금전 핵심 키워드 2~3개",
      "upright": "정방향 금전 해석 2문장. 반드시 마침표로 끝낼 것.",
      "reversed": "역방향 금전 해석 2문장. 반드시 마침표로 끝낼 것."
    }`).join(",\n    ")}
  ]
}
JSON만 출력.`;
...
function buildSectionHtml(
  ...
  const multiCardsHtml = extraCardFiles.length > 0
    ...
    : "";
  html += `<div class="pg">${hd}<div class="pg-body">${badge}${multiCardsHtml}<div class="cmp-row"><div class="bad-box"><div class="box-title">✕ 이렇게 하면 안 돼요</div><ul>${sec.badExamples.slice(0,3).map(e=>`<li>${e}</li>`).join("")}</ul></div><div class="good-box"><div class="box-title">✓ 이렇게 해보세요</div><ul>${sec.goodExamples.slice(0,3).map(e=>`<li>${e}</li>`).join("")}</ul></div></div>${sec.subheadings[2]?`<div class="sub-h">${sec.subheadings[2].title.replace(/\.+$/, "")}</div><p class="body-p">${trimSentences(sec.subheadings[2].body,2)}</p>`:""}<div class="quote-box"><p>"${sec.quote}"</p></div></div><div class="pg-ft"><div class="pn">${pg++}</div><div class="pt">Tarot Money Guide</div></div></div>`;
  // 페이지 3
...
function buildSectionPrompt(
  ...
  if (chapterNum === 3) {
    ...
    const sub1Body = is3card
      ...
      : "2문장. 어떤 카드든 통용되는 금전 위치/조합 해석 원칙을 빠짐없이 압축. 다루는 원칙 모두 포함. 반드시 카드 이름을 명시하며 예시를 들 것. 절대 이 카드 라고만 쓰지 말 것. 반드시 존댓말로, 마침표로 끝낼 것.";
    ...
    const casesPrompt = is5card
      ? `{"question": "구체적인 금전 고민을 자연스러운 질문 문장 1줄로 작성할 것. 이어서 '이때 [카드명1], [카드명2], [카드명3], [카드명4], [카드명5]이 나왔어요. 어떻게 해석해야 할까요?' 형식으로. 정방향/역방향 정보도 포함할 것. 다른 케이스와 다른 상황으로.", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 상황/원인/장애/조언/결과 전체를 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."},
    {"question": "앞과 다른 구체적인 금전 고민을 자연스러운 질문 문장 1줄로 작성할 것. 이어서 '이때 [카드명1], [카드명2], [카드명3], [카드명4], [카드명5]이 나왔어요. 어떻게 해석해야 할까요?' 형식으로. 정방향/역방향 정보도 포함할 것. 완전히 다른 상황으로.", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 상황/원인/장애/조언/결과 전체를 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."}`
      : `{"question": "\구체적인 금전 고민을 자연스러운 질문 문장 1줄로 작성할 것 (예: ~을 고민 중인데 어떻게 해야 할까요?). 이어서 '이때 [카드명1], [카드명2], [카드명3]이 나왔어요. 어떻게 해석해야 할까요?' 형식으로. 정방향/역방향 정보도 포함할 것. 반드시 질문에 카드명 포함. 다른 케이스와 완전히 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."},
    {"question": "\앞과 다른 구체적인 금전 고민을 자연스러운 질문 문장 1줄로 작성할 것. 이어서 '이때 [카드명1], [카드명2], [카드명3]이 나왔어요. 어떻게 해석해야 할까요?' 형식으로. 정방향/역방향 정보도 포함할 것. 반드시 질문에 카드명 포함. 완전히 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."},
    {"question": "\앞 둘과 다른 구체적인 금전 고민을 자연스러운 질문 문장 1줄로 작성할 것. 이어서 '이때 [카드명1], [카드명2], [카드명3]이 나왔어요. 어떻게 해석해야 할까요?' 형식으로. 정방향/역방향 정보도 포함할 것. 반드시 질문에 카드명 포함. 완전히 다른 상황으로", "answer": "2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 반드시 존댓말로, 마침표로 끝낼 것."}`;
...
- 표 내용은 독자가 쉽게 이해할 수 있는 표현으로. "정역방향 혼재", "궁정카드 포함" 등 어려운 전문용어 절대 금지. "수입 자리에 펜타클 카드가 나오면"처럼 자연스러운 표현으로.
- 반드시 존댓말(~해요, ~입니다, ~이에요)로만 작성할 것. 반말, 단답형, ~한다, ~이다, ~해라 절대 금지.
- 카드 이름은 반드시 한국어로 작성할 것. 영어 카드명 절대 금지.
- 마이너 아르카나 카드명 주의: 완드(지팡이/막대 절대 금지), 펜타클(동전/코인 절대 금지), 컵(성배/잔 절대 금지), 검(소드/칼 절대 금지). 반드시 챕터1 이름 그대로: 완드 페이지, 펜타클 8, 컵 나이트, 검 퀸 등으로 작성할 것.
- 카드 한국어명 주의: 여황제→여황제, 매달린 사람→매달린 사람, 검 킹→검 킹, The Fool→바보, The Hermit→은둔자, Wheel of Fortune→운명의 수레바퀴로 작성할 것. 마이너 아르카나 카드명 주의: 완드(지팡이/막대 절대 금지), 펜타클(동전/코인 절대 금지), 컵(성배/잔 절대 금지), 검(소드/칼 절대 금지). 반드시 챕터1에서 사용된 이름 그대로: 완드 페이지, 펜타클 8, 컵 나이트, 검 퀸 등으로 작성할 것.
- 케이스와 퀴즈는 반드시 금전·재테크에 관한 내용으로만 작성할 것. 연애·자아성찰 내용 절대 금지.
{
  ...
  "subheadings": [
    ...
    {"title": "💬 소제목3 — 실전 적용법", "body": "2문장. 실제 금전 리딩에서 이 원칙 적용법을 빠짐없이 카드명 명시하며 압축 설명. 다루는 내용 모두 포함. 절대 이 카드 라고만 쓰지 말 것. 반드시 마침표로 끝낼 것."}
  ],
  "extraCards": [
    ${section.extraCards.map(c=>`{"file": "${c.file}", "name": "${c.name}", "interp": "이 카드가 해당 금전 위치/조합에서 갖는 의미 한 줄."}`).join(",\n    ")}
  ],
  "badExamples": ["잘못된 금전 해석 예시 1. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이","잘못된 금전 해석 예시 2. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이","잘못된 금전 해석 예시 3. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이"],
  "goodExamples": ["올바른 금전 해석 예시 1. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이","올바른 금전 해석 예시 2. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이","올바른 금전 해석 예시 3. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이"],
  "tableHeaders": ["위치/상황","어떤 카드든 이렇게 읽는다","주의할 점"],
  "tableRows": [
    {"col1":"구체적 금전 상황을 일반인도 이해할 수 있는 쉬운 말로. 예: 수입 자리에 펜타클 카드가 나왔을 때. 궁정카드/정역방향혼재 등 전문용어 절대 금지","col2":"해석 원칙 설명 1. 쉬운 표현으로","col3":"주의할 점 1"},
    {"col1":"구체적 금전 상황 2. 쉬운 말로. 전문용어 금지","col2":"해석 원칙 설명 2. 쉬운 표현으로","col3":"주의할 점 2"},
    {"col1":"구체적 금전 상황 3. 쉬운 말로. 전문용어 금지","col2":"해석 원칙 설명 3. 쉬운 표현으로","col3":"주의할 점 3"},
    {"col1":"구체적 금전 상황 4. 쉬운 말로. 전문용어 금지","col2":"해석 원칙 설명 4. 쉬운 표현으로","col3":"주의할 점 4"},
    {"col1":"구체적 금전 상황 5. 쉬운 말로. 전문용어 금지","col2":"해석 원칙 설명 5. 쉬운 표현으로","col3":"주의할 점 5"}
  ],
  ...
  "quiz": {
    "question": "연습 퀴즈: 구체적인 금전 고민을 자연스러운 질문 문장 1줄로 작성. 이어서 이때 [카드명1], [카드명2], [카드명3]이 나왔어요. 어떻게 해석해야 할까요? 형식으로. 정방향/역방향 정보 포함. 1~2줄 이내.",
...
JSON만 출력.`;
  ...
  if (chapterNum === 4 || chapterNum === 5) {
    const quizAnswer = "2문장. 카드를 하나씩 나열하지 말고 전체 배열을 하나의 흐름으로 통합 해석. 모든 카드와 결론까지 반드시 포함. 내용이 풍부하고 빠지는 카드 없이. 반드시 존댓말로, 마침표로 끝낼 것.";
    return `타로 전자책 전문 작가입니다. 섹션 1개의 내용을 JSON으로만 작성하세요. JSON 외 텍스트 절대 금지.
챕터 ${chapterNum}: ${chapterTitle}
섹션 ${si+1}: ${section.title}
...
- 독자가 어떤 카드가 나와도 이 금전 상황을 해석할 수 있도록 여러 옵션 제공.
...
- 케이스와 퀴즈는 반드시 금전·재테크에 관한 내용으로만 작성할 것. 연애·자아성찰 내용 절대 금지.
{
  ...
  "subheadings": [
    ...
    {"title": "💬 소제목3 — 배열 위치별 적용", "body": "2문장. 이 금전 상황에서 3카드 또는 5카드 배열의 각 위치별 해석을 빠짐없이 카드명 명시하며 하나의 흐름으로 압축. 다루는 위치 모두 포함. 절대 이 카드 라고만 쓰지 말 것. 반드시 마침표로 끝낼 것."}
  ],
  "extraCards": [
  ...
  "badExamples": ["잘못된 금전 해석 예시 1. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이","잘못된 금전 해석 예시 2. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이","잘못된 금전 해석 예시 3. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이"],
  "goodExamples": ["올바른 금전 해석 예시 1. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이","올바른 금전 해석 예시 2. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이","올바른 금전 해석 예시 3. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이"],
  "tableHeaders": ["나온 카드","이 금전 상황에서의 의미","주의/조언"],
  "tableRows": [
    {"col1":"카드1 (챕터1 카드명 그대로. 전문용어 금지)","col2":"이 금전 상황에서 의미1. 쉬운 표현으로","col3":"조언1"},
    {"col1":"카드2 (챕터1 카드명 그대로. 전문용어 금지)","col2":"이 금전 상황에서 의미2. 쉬운 표현으로","col3":"조언2"},
    {"col1":"카드3 (챕터1 카드명 그대로. 전문용어 금지)","col2":"이 금전 상황에서 의미3. 쉬운 표현으로","col3":"조언3"},
    {"col1":"카드4 (챕터1 카드명 그대로. 전문용어 금지)","col2":"이 금전 상황에서 의미4. 쉬운 표현으로","col3":"조언4"},
    {"col1":"카드5 (챕터1 카드명 그대로. 전문용어 금지)","col2":"이 금전 상황에서 의미5. 쉬운 표현으로","col3":"조언5"}
  ],
  ...
  "quiz": {
    "question": "🎯 실전 퀴즈: 구체적인 금전 고민을 자연스러운 질문 문장 1줄로 작성. 이어서 이때 1번:[카드명], 2번:[카드명], 3번:[카드명]이 나왔어요. 어떻게 해석해야 할까요? 형식으로. 정방향/역방향 정보 포함. 1~2줄 이내.",
...
{"title":"${section.title}","cardFile":"${section.card}","cardName":"${section.cardName}","cardDesc":"7~8문장. 이 카드의 금전 핵심 의미. 정방향과 역방향, 실제 금전 상황 예시, 독자가 바로 공감할 수 있는 구체적 내용 포함. 반드시 존댓말로, 마침표로 끝낼 것.","cardTagline":"이 카드의 금전 핵심 메시지 한 줄.","subheadings":[{"title":"🔮 소제목1","body":"5~6문장. 이 소제목에서 다루는 핵심 금전 내용을 빠짐없이. 반드시 카드 이름을 명시하며 예시를 들 것. 절대 이 카드 라고만 쓰지 말 것. 반드시 존댓말로, 마침표로 끝낼 것."},{"title":"💡 소제목2","body":"5~6문장. 이 소제목에서 다루는 실전 금전 적용법을 빠짐없이. 반드시 카드 이름을 명시하며 그 카드가 나왔을 때 어떻게 활용하는지 설명할 것. 절대 이 카드 라고만 쓰지 말 것. 반드시 존댓말로, 마침표로 끝낼 것."},{"title":"💬 소제목3","body":"5~6문장. 이 소제목에서 다루는 금전 예시를 빠짐없이. 반드시 카드 이름을 명시하며 그 카드가 어떤 의미인지 설명하고 나서 예시를 들 것. 절대 이 카드 라고만 쓰지 말 것. 반드시 존댓말로, 마침표로 끝낼 것. 절대 빈칸으로 두지 말 것."}],"extraCards":[${section.extraCards.map(c=>`{"file":"${c.file}","name":"${c.name}","interp":"금전 리딩에서 한 줄 의미. 존댓말로"}`).join(",")}],"badExamples":["잘못된 금전 해석 예시 1. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이","잘못된 금전 해석 예시 2. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이","잘못된 금전 해석 예시 3. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이"],"goodExamples":["올바른 금전 해석 예시 1. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이","올바른 금전 해석 예시 2. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이","올바른 금전 해석 예시 3. 핵심만 15자 이내 키워드로 압축. 내용 빠짐없이"],"tableHeaders":["금전 상황","정방향 의미","역방향 의미"],"tableRows":[{"col1":"구체적 금전 상황 1. 일반인도 이해할 수 있는 쉬운 말로. 전문용어 금지","col2":"정방향일 때 금전 의미. 쉬운 표현으로","col3":"역방향일 때 금전 의미. 쉬운 표현으로"},{"col1":"구체적 금전 상황 2. 쉬운 말로. 전문용어 금지","col2":"정방향일 때 금전 의미. 쉬운 표현으로","col3":"역방향일 때 금전 의미. 쉬운 표현으로"},{"col1":"구체적 금전 상황 3. 쉬운 말로. 전문용어 금지","col2":"정방향일 때 금전 의미. 쉬운 표현으로","col3":"역방향일 때 금전 의미. 쉬운 표현으로"},{"col1":"구체적 금전 상황 4. 쉬운 말로. 전문용어 금지","col2":"정방향일 때 금전 의미. 쉬운 표현으로","col3":"역방향일 때 금전 의미. 쉬운 표현으로"},{"col1":"구체적 금전 상황 5. 쉬운 말로. 전문용어 금지","col2":"정방향일 때 금전 의미. 쉬운 표현으로","col3":"역방향일 때 금전 의미. 쉬운 표현으로"}],"quote":"금전 리딩 핵심 명언을 존댓말로 한 문장","tip":"실전 금전 리딩 팁을 존댓말로 2문장.","cases":[{"question":"구체적인 금전 고민을 자연스러운 질문 문장 1줄로 작성할 것 (예: ~을 고민 중인데 어떻게 해야 할까요?). 이어서 '이때 [카드명1], [카드명2], [카드명3]이 나왔어요. 어떻게 해석해야 할까요?' 형식으로. 정방향/역방향 정보도 포함할 것. 반드시 질문에 카드명 포함. 다른 케이스와 완전히 다른 상황으로.","answer":"2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 카드명은 반드시 챕터1 이름 그대로(컵/완드/검/펜타클). 성배·지팡이·동전·소드 절대 금지. 반드시 존댓말로, 마침표로 끝낼 것."},{"question":"앞과 다른 구체적인 금전 고민을 자연스러운 질문 문장 1줄로 작성할 것. 이어서 '이때 [카드명1], [카드명2], [카드명3]이 나왔어요. 어떻게 해석해야 할까요?' 형식으로. 정방향/역방향 정보도 포함할 것. 반드시 질문에 카드명 포함. 완전히 다른 상황으로.","answer":"2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 카드명은 반드시 챕터1 이름 그대로(컵/완드/검/펜타클). 성배·지팡이·동전·소드 절대 금지. 반드시 존댓말로, 마침표로 끝낼 것."},{"question":"앞 둘과 다른 구체적인 금전 고민을 자연스러운 질문 문장 1줄로 작성할 것. 이어서 '이때 [카드명1], [카드명2], [카드명3]이 나왔어요. 어떻게 해석해야 할까요?' 형식으로. 정방향/역방향 정보도 포함할 것. 반드시 질문에 카드명 포함. 완전히 다른 상황으로.","answer":"2문장. 질문에 나온 카드 전부를 빠짐없이 포함하여 하나의 흐름으로 통합 해석. 결론까지 반드시. 카드명은 반드시 챕터1 이름 그대로(컵/완드/검/펜타클). 성배·지팡이·동전·소드 절대 금지. 반드시 존댓말로, 마침표로 끝낼 것."}],"quiz":{"question":"🎯 금전 퀴즈: 구체적인 금전 고민을 자연스러운 질문 문장 1줄로 작성. 이어서 이때 [카드명1], [카드명2], [카드명3]이 나왔어요. 어떻게 해석해야 할까요? 형식으로. 정방향/역방향 정보 포함. 1~2줄 이내.","hint":"존댓말로 힌트 한 줄","answer":"2문장. 카드를 하나씩 나열하지 말고 전체 배열을 하나의 흐름으로 통합 해석. 모든 카드와 결론까지 반드시 포함. 카드명은 반드시 챕터1 이름 그대로(컵/완드/검/펜타클). 성배·지팡이·동전·소드 절대 금지. 반드시 존댓말로, 마침표로 끝낼 것."},"summary":["존댓말로 핵심 요약 1","존댓말로 핵심 요약 2","존댓말로 핵심 요약 3","존댓말로 핵심 요약 4"]}`;
}
// ── API Route ──────────────────────────────────────────
export async function POST(req: NextRequest) {
  try {
    ...
    const msg = await client.messages.create({
      ...
      max_tokens: chapter.number === 2 ? 8192 : 8192,
