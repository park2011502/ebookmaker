...

{
  ...
  "cases": [
    {"question": "${section.title} 관련 실제 커리어 상담에서 자주 나오는 질문 1. 구체적 커리어 고민 상황 포함. 카드 3장 이상 배열 사용. 다른 케이스와 완전히 다른 상황으로", "answer": "${is5card ? '2문장. 카드를 하나씩 나열하지 말고 전체 배열을 하나의 흐름으로 통합 해석. 모든 카드와 결론까지 반드시 포함. 내용이 풍부하고 빠지는 카드 없이. 반드시 존댓말로, 마침표로 끝낼 것.' : '존댓말로 4~5문장. 반드시 구체적인 카드명을 언급하며 위치/조합 원칙 적용한 풍부한 해석. 반드시 마침표로 끝낼 것'}"},
    {"question": "${section.title} 관련 실제 커리어 상담에서 자주 나오는 질문 2. 앞의 질문과 완전히 다른 커리어 상황으로", "answer": "${is5card ? '2문장. 카드를 하나씩 나열하지 말고 전체 배열을 하나의 흐름으로 통합 해석. 모든 카드와 결론까지 반드시 포함. 내용이 풍부하고 빠지는 카드 없이. 반드시 존댓말로, 마침표로 끝낼 것.' : '존댓말로 4~5문장. 반드시 구체적인 카드명을 언급하며 위치/조합 원칙 적용한 풍부한 해석. 반드시 마침표로 끝낼 것'}"},
    {"question": "${section.title} 관련 실제 커리어 상담에서 자주 나오는 질문 3. 앞의 두 질문과 완전히 다른 커리어 상황으로", "answer": "존댓말로 4~5문장. 반드시 구체적인 카드명을 언급하며 위치/조합 원칙 적용한 풍부한 해석. 반드시 마침표로 끝낼 것"}
  ],
  "quiz": {
